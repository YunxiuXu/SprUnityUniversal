...
namespace SprCs {
	...
	public float rotationFriction {
	    get { return SprExport.Spr_PHMaterial_get_rotationFriction(_this); }
	    set { SprExport.Spr_PHMaterial_set_rotationFriction(_this, value); }
	}
	public float spring {
	...
	public float stribeckmu {
        ...
        public vectorwrapper_float mus {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_mus(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_mus(_this, value); }
        }
        public vectorwrapper_float mu0s {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_mu0s(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_mu0s(_this, value); }
        }
        public vectorwrapper_float timeVaryFrictionAs {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_timeVaryFrictionAs(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_timeVaryFrictionAs(_this, value); }
        }
        public vectorwrapper_float timeVaryFrictionBs {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_timeVaryFrictionBs(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_timeVaryFrictionBs(_this, value); }
        }
        public vectorwrapper_float timeVaryFrictionDs {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_timeVaryFrictionDs(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_timeVaryFrictionDs(_this, value); }
        }
        public vectorwrapper_float timeVaryFrictionCs {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_timeVaryFrictionCs(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_timeVaryFrictionCs(_this, value); }
        }
        public vectorwrapper_float stribeckVelocitys {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_stribeckVelocitys(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_stribeckVelocitys(_this, value); }
        }
        public vectorwrapper_float stribeckmus {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_stribeckmus(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_stribeckmus(_this, value); }
        }
        public vectorwrapper_double c {
            get { return new vectorwrapper_double(SprExport.Spr_PHMaterial_vector_addr_c(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_c(_this, value); }
        }
        public vectorwrapper_float bristleK {
            get { return new vectorwrapper_float(SprExport.Spr_PHMaterial_vector_addr_bristleK(_this)); }
            set { SprExport.Spr_PHMaterial_vector_set_bristleK(_this, value); }
        }
	...
	public float stribeckVelocity;
	public float stribeckmu;
	public vectorwrapper_float mus = new vectorwrapper_float();
	public vectorwrapper_float mu0s = new vectorwrapper_float();
	public vectorwrapper_float timeVaryFrictionAs = new vectorwrapper_float();
	public vectorwrapper_float timeVaryFrictionBs = new vectorwrapper_float();
	public vectorwrapper_float timeVaryFrictionDs = new vectorwrapper_float();
	public vectorwrapper_float timeVaryFrictionCs = new vectorwrapper_float();
	public vectorwrapper_float stribeckVelocitys = new vectorwrapper_float();
	public vectorwrapper_float stribeckmus = new vectorwrapper_float();
	public vectorwrapper_double c = new vectorwrapper_double();
	public vectorwrapper_float bristleK = new vectorwrapper_float();
	public int velocityFieldMode;
	public Vec3dStruct velocityFieldAxis;
	public double velocityFieldMagnitude;
// _[Find class node: 2916] PHMaterial
	public void ApplyTo(PHMaterial r, bool apply_to_base_class=true) {
		r.density = density;
		r.mu = mu;
		r.mu0 = mu0;
		r.e = e;
		r.rotationFriction = rotationFriction;
		r.spring = spring;
		r.damper = damper;
		...
		r.mus.clear();
		int _PHMaterial_count_0023 = mus.size();
		for (int i = 0; i < _PHMaterial_count_0023; i++) {
			r.mus.push_back(mus[i]);
		}
		r.mu0s.clear();
		int _PHMaterial_count_0024 = mu0s.size();
		for (int i = 0; i < _PHMaterial_count_0024; i++) {
			r.mu0s.push_back(mu0s[i]);
		}
		r.timeVaryFrictionAs.clear();
		int _PHMaterial_count_0025 = timeVaryFrictionAs.size();
		for (int i = 0; i < _PHMaterial_count_0025; i++) {
			r.timeVaryFrictionAs.push_back(timeVaryFrictionAs[i]);
		}
		r.timeVaryFrictionBs.clear();
		int _PHMaterial_count_0026 = timeVaryFrictionBs.size();
		for (int i = 0; i < _PHMaterial_count_0026; i++) {
			r.timeVaryFrictionBs.push_back(timeVaryFrictionBs[i]);
		}
		r.timeVaryFrictionDs.clear();
		int _PHMaterial_count_0027 = timeVaryFrictionDs.size();
		for (int i = 0; i < _PHMaterial_count_0027; i++) {
			r.timeVaryFrictionDs.push_back(timeVaryFrictionDs[i]);
		}
		r.timeVaryFrictionCs.clear();
		int _PHMaterial_count_0028 = timeVaryFrictionCs.size();
		for (int i = 0; i < _PHMaterial_count_0028; i++) {
			r.timeVaryFrictionCs.push_back(timeVaryFrictionCs[i]);
		}
		r.stribeckVelocitys.clear();
		int _PHMaterial_count_0029 = stribeckVelocitys.size();
		for (int i = 0; i < _PHMaterial_count_0029; i++) {
			r.stribeckVelocitys.push_back(stribeckVelocitys[i]);
		}
		r.stribeckmus.clear();
		int _PHMaterial_count_0030 = stribeckmus.size();
		for (int i = 0; i < _PHMaterial_count_0030; i++) {
			r.stribeckmus.push_back(stribeckmus[i]);
		}
		r.c.clear();
		int _PHMaterial_count_0031 = c.size();
		for (int i = 0; i < _PHMaterial_count_0031; i++) {
			r.c.push_back(c[i]);
		}
		r.bristleK.clear();
		int _PHMaterial_count_0032 = bristleK.size();
		for (int i = 0; i < _PHMaterial_count_0032; i++) {
			r.bristleK.push_back(bristleK[i]);
		}
	...
	public void ApplyFrom(PHMaterial r, bool apply_to_base_class=true) {
		density = r.density;
		mu = r.mu;
		mu0 = r.mu0;
		e = r.e;
		rotationFriction = r.rotationFriction;
		spring = r.spring;
		damper = r.damper;
		...
		mus.clear();
		int _PHMaterial_count_0023 = r.mus.size();
		for (int i = 0; i < _PHMaterial_count_0023; i++) {
			mus.push_back(r.mus[i]);
		}
		mu0s.clear();
		int _PHMaterial_count_0024 = r.mu0s.size();
		for (int i = 0; i < _PHMaterial_count_0024; i++) {
			mu0s.push_back(r.mu0s[i]);
		}
		timeVaryFrictionAs.clear();
		int _PHMaterial_count_0025 = r.timeVaryFrictionAs.size();
		for (int i = 0; i < _PHMaterial_count_0025; i++) {
			timeVaryFrictionAs.push_back(r.timeVaryFrictionAs[i]);
		}
		timeVaryFrictionBs.clear();
		int _PHMaterial_count_0026 = r.timeVaryFrictionBs.size();
		for (int i = 0; i < _PHMaterial_count_0026; i++) {
			timeVaryFrictionBs.push_back(r.timeVaryFrictionBs[i]);
		}
		timeVaryFrictionDs.clear();
		int _PHMaterial_count_0027 = r.timeVaryFrictionDs.size();
		for (int i = 0; i < _PHMaterial_count_0027; i++) {
			timeVaryFrictionDs.push_back(r.timeVaryFrictionDs[i]);
		}
		timeVaryFrictionCs.clear();
		int _PHMaterial_count_0028 = r.timeVaryFrictionCs.size();
		for (int i = 0; i < _PHMaterial_count_0028; i++) {
			timeVaryFrictionCs.push_back(r.timeVaryFrictionCs[i]);
		}
		stribeckVelocitys.clear();
		int _PHMaterial_count_0029 = r.stribeckVelocitys.size();
		for (int i = 0; i < _PHMaterial_count_0029; i++) {
			stribeckVelocitys.push_back(r.stribeckVelocitys[i]);
		}
		stribeckmus.clear();
		int _PHMaterial_count_0030 = r.stribeckmus.size();
		for (int i = 0; i < _PHMaterial_count_0030; i++) {
			stribeckmus.push_back(r.stribeckmus[i]);
		}
		c.clear();
		int _PHMaterial_count_0031 = r.c.size();
		for (int i = 0; i < _PHMaterial_count_0031; i++) {
			c.push_back(r.c[i]);
		}
		bristleK.clear();
		int _PHMaterial_count_0032 = r.bristleK.size();
		for (int i = 0; i < _PHMaterial_count_0032; i++) {
			bristleK.push_back(r.bristleK[i]);
		}
...
// _[Find class node: 2916] CDShapeDesc
	public void ApplyTo(CDShapeDesc r, bool apply_to_base_class=true) {
		r.material = material;
	}
	public void ApplyFrom(CDShapeDesc r, bool apply_to_base_class=true) {
		material = r.material;
	}
    ...
    public vectorwrapper_Vec3f vertices {
        get { return new vectorwrapper_Vec3f(SprExport.Spr_CDConvexMeshDesc_vector_get_vertices(_this)); }
        set { SprExport.Spr_CDConvexMeshDesc_vector_set_vertices(_this, value._this); }
    }
    }
    [System.Serializable]
...
// _[Find class node: 2916] CDConvexMeshDesc
	public void ApplyTo(CDConvexMeshDesc r, bool apply_to_base_class=true) {
		r.vertices.clear();
		int _CDConvexMeshDesc_count_0000 = vertices.size();
		for (int i = 0; i < _CDConvexMeshDesc_count_0000; i++) {
			r.vertices.push_back(vertices[i]);
		}
		if (apply_to_base_class) {
		    base.ApplyTo((CDShapeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(CDConvexMeshDesc r, bool apply_to_base_class=true) {
		vertices.clear();
		int _CDConvexMeshDesc_count_0000 = r.vertices.size();
		for (int i = 0; i < _CDConvexMeshDesc_count_0000; i++) {
			vertices.push_back(r.vertices[i]);
		}
		if (apply_to_base_class) {
		    base.ApplyFrom((CDShapeDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] CDConvexMeshInterpolateDesc
	public void ApplyTo(CDConvexMeshInterpolateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((CDConvexMeshDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(CDConvexMeshInterpolateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((CDConvexMeshDesc) r, apply_to_base_class);
		}
	}
	...
	public float radius;
// _[Find class node: 2916] CDSphereDesc
	public void ApplyTo(CDSphereDesc r, bool apply_to_base_class=true) {
		r.radius = radius;
		if (apply_to_base_class) {
		    base.ApplyTo((CDShapeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(CDSphereDesc r, bool apply_to_base_class=true) {
		radius = r.radius;
		if (apply_to_base_class) {
		    base.ApplyFrom((CDShapeDesc) r, apply_to_base_class);
		}
...
// _[Find class node: 2916] CDEllipsoidDesc
	public void ApplyTo(CDEllipsoidDesc r, bool apply_to_base_class=true) {
		r.radius = radius;
		if (apply_to_base_class) {
		    base.ApplyTo((CDShapeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(CDEllipsoidDesc r, bool apply_to_base_class=true) {
		radius = r.radius;
		if (apply_to_base_class) {
		    base.ApplyFrom((CDShapeDesc) r, apply_to_base_class);
		}
	...
	public float radius;
	public float length;
// _[Find class node: 2916] CDCapsuleDesc
	public void ApplyTo(CDCapsuleDesc r, bool apply_to_base_class=true) {
		r.radius = radius;
		r.length = length;
		if (apply_to_base_class) {
		    base.ApplyTo((CDShapeDesc) r, apply_to_base_class);
	...
	public void ApplyFrom(CDCapsuleDesc r, bool apply_to_base_class=true) {
		radius = r.radius;
		length = r.length;
		if (apply_to_base_class) {
		    base.ApplyFrom((CDShapeDesc) r, apply_to_base_class);
	...
	public float length;
// _[Find class node: 2916] CDRoundConeDesc
	public void ApplyTo(CDRoundConeDesc r, bool apply_to_base_class=true) {
		r.radius = radius;
		r.length = length;
		if (apply_to_base_class) {
		    base.ApplyTo((CDShapeDesc) r, apply_to_base_class);
	...
	public void ApplyFrom(CDRoundConeDesc r, bool apply_to_base_class=true) {
		radius = r.radius;
		length = r.length;
		if (apply_to_base_class) {
		    base.ApplyFrom((CDShapeDesc) r, apply_to_base_class);
...
// _[Find class node: 2916] CDBoxDesc
	public void ApplyTo(CDBoxDesc r, bool apply_to_base_class=true) {
		r.boxsize = boxsize;
		if (apply_to_base_class) {
		    base.ApplyTo((CDShapeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(CDBoxDesc r, bool apply_to_base_class=true) {
		boxsize = r.boxsize;
		if (apply_to_base_class) {
		    base.ApplyFrom((CDShapeDesc) r, apply_to_base_class);
		}
	...
	public double depth;
	public uint lastContactCount;
// _[Find class node: 2916] CDShapePairState
	public void ApplyTo(CDShapePairState r, bool apply_to_base_class=true) {
		r.normal = normal;
		r.depth = depth;
		r.lastContactCount = lastContactCount;
	}
	public void ApplyFrom(CDShapePairState r, bool apply_to_base_class=true) {
		normal = r.normal;
		depth = r.depth;
...
// _[Find class node: 2916] CDSpatialHashTableDesc
	public void ApplyTo(CDSpatialHashTableDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(CDSpatialHashTableDesc r, bool apply_to_base_class=true) {
	}
	...
	public int[] GetIndices() {
	    IntPtr ptr = SprExport.Spr_CDFaceIf_GetIndices((IntPtr) _this);
	...
	public int[] GetIndices() {
	    IntPtr ptr = SprExport.Spr_CDQuadFaceIf_GetIndices((IntPtr) _this);
            int size = 1;   // no way to know array size!
            return new arraywrapper_int(ptr, size);
	}
    }
