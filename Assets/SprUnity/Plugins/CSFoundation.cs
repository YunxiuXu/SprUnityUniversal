...
namespace SprCs {
	...
	public float x;
	public float y;
// _[Find class node: 2916] Vec2f
	public void ApplyTo(Vec2f r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
	}
	public void ApplyFrom(Vec2f r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
	}
	...
	public double x;
	public double y;
// _[Find class node: 2916] Vec2d
	public void ApplyTo(Vec2d r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
	}
	public void ApplyFrom(Vec2d r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
	}
	...
	public float y;
	public float z;
// _[Find class node: 2916] Vec3f
	public void ApplyTo(Vec3f r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
		r.z = z;
	}
	public void ApplyFrom(Vec3f r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
		z = r.z;
	}
	...
	public double y;
	public double z;
// _[Find class node: 2916] Vec3d
	public void ApplyTo(Vec3d r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
		r.z = z;
	}
	public void ApplyFrom(Vec3d r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
		z = r.z;
	}
	...
	public float z;
	public float w;
// _[Find class node: 2916] Vec4f
	public void ApplyTo(Vec4f r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
		r.z = z;
		r.w = w;
	}
	public void ApplyFrom(Vec4f r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
		z = r.z;
		w = r.w;
	...
	public double z;
	public double w;
// _[Find class node: 2916] Vec4d
	public void ApplyTo(Vec4d r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
		r.z = z;
		r.w = w;
	}
	public void ApplyFrom(Vec4d r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
		z = r.z;
		w = r.w;
	...
	public float z;
	public float w;
// _[Find class node: 2916] Quaternionf
	public void ApplyTo(Quaternionf r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
		r.z = z;
		r.w = w;
	}
	public void ApplyFrom(Quaternionf r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
		z = r.z;
		w = r.w;
	...
	public double z;
	public double w;
// _[Find class node: 2916] Quaterniond
	public void ApplyTo(Quaterniond r, bool apply_to_base_class=true) {
		r.x = x;
		r.y = y;
		r.z = z;
		r.w = w;
	}
	public void ApplyFrom(Quaterniond r, bool apply_to_base_class=true) {
		x = r.x;
		y = r.y;
		z = r.z;
		w = r.w;
	...
	public float py;
	public float pz;
// _[Find class node: 2916] Posef
	public void ApplyTo(Posef r, bool apply_to_base_class=true) {
		r.w = w;
		r.x = x;
		r.y = y;
		r.z = z;
	...
	public void ApplyFrom(Posef r, bool apply_to_base_class=true) {
		w = r.w;
		x = r.x;
		y = r.y;
		z = r.z;
	...
	public double py;
	public double pz;
// _[Find class node: 2916] Posed
	public void ApplyTo(Posed r, bool apply_to_base_class=true) {
		r.w = w;
		r.x = x;
		r.y = y;
		r.z = z;
	...
	public void ApplyFrom(Posed r, bool apply_to_base_class=true) {
		w = r.w;
		x = r.x;
		y = r.y;
		z = r.z;
	...
	public float wy;
	public float wz;
// _[Find class node: 2916] Vec6f
	public void ApplyTo(Vec6f r, bool apply_to_base_class=true) {
		r.vx = vx;
		r.vy = vy;
		r.vz = vz;
		r.wx = wx;
	...
	public void ApplyFrom(Vec6f r, bool apply_to_base_class=true) {
		vx = r.vx;
		vy = r.vy;
		vz = r.vz;
		wx = r.wx;
	...
	public double wy;
	public double wz;
// _[Find class node: 2916] Vec6d
	public void ApplyTo(Vec6d r, bool apply_to_base_class=true) {
		r.vx = vx;
		r.vy = vy;
		r.vz = vz;
		r.wx = wx;
	...
	public void ApplyFrom(Vec6d r, bool apply_to_base_class=true) {
		vx = r.vx;
		vy = r.vy;
		vz = r.vz;
		wx = r.wx;
...
// _[Find class node: 2916] Curve3f
	public void ApplyTo(Curve3f r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(Curve3f r, bool apply_to_base_class=true) {
	}
	...
	public float zy;
	public float zz;
// _[Find class node: 2916] Matrix3f
	public void ApplyTo(Matrix3f r, bool apply_to_base_class=true) {
		r.xx = xx;
		r.xy = xy;
		r.xz = xz;
		r.yx = yx;
	...
	public void ApplyFrom(Matrix3f r, bool apply_to_base_class=true) {
		xx = r.xx;
		xy = r.xy;
		xz = r.xz;
		yx = r.yx;
	...
	public double zy;
	public double zz;
// _[Find class node: 2916] Matrix3d
	public void ApplyTo(Matrix3d r, bool apply_to_base_class=true) {
		r.xx = xx;
		r.xy = xy;
		r.xz = xz;
		r.yx = yx;
	...
	public void ApplyFrom(Matrix3d r, bool apply_to_base_class=true) {
		xx = r.xx;
		xy = r.xy;
		xz = r.xz;
		yx = r.yx;
	...
	public float pz;
	public float pw;
// _[Find class node: 2916] Affinef
	public void ApplyTo(Affinef r, bool apply_to_base_class=true) {
		r.xx = xx;
		r.xy = xy;
		r.xz = xz;
		r.xw = xw;
	...
	public void ApplyFrom(Affinef r, bool apply_to_base_class=true) {
		xx = r.xx;
		xy = r.xy;
		xz = r.xz;
		xw = r.xw;
	...
	public double pz;
	public double pw;
// _[Find class node: 2916] Affined
	public void ApplyTo(Affined r, bool apply_to_base_class=true) {
		r.xx = xx;
		r.xy = xy;
		r.xz = xz;
		r.xw = xw;
	...
	public void ApplyFrom(Affined r, bool apply_to_base_class=true) {
		xx = r.xx;
		xy = r.xy;
		xz = r.xz;
		xw = r.xw;
