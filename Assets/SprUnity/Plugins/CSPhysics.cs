...
namespace SprCs {
	...
	public bool bUseContactSurface;
	public bool bReport;
// _[Find class node: 2916] PHConstraintEngineDesc
	public void ApplyTo(PHConstraintEngineDesc r, bool apply_to_base_class=true) {
		r.method = method;
		r.numIter = numIter;
	...
	public void ApplyFrom(PHConstraintEngineDesc r, bool apply_to_base_class=true) {
		method = r.method;
		numIter = r.numIter;
	...
	public int solverMode {
	    get { return SprExport.Spr_PHIKEngineDesc_get_solverMode(_this); }
	    set { SprExport.Spr_PHIKEngineDesc_set_solverMode(_this, value); }
	}
	...
	public int iterGaussSeidel;
	public int solverMode;
// _[Find class node: 2916] PHIKEngineDesc
	public void ApplyTo(PHIKEngineDesc r, bool apply_to_base_class=true) {
		r.numIter = numIter;
		r.maxVel = maxVel;
	...
	public void ApplyFrom(PHIKEngineDesc r, bool apply_to_base_class=true) {
		numIter = r.numIter;
		maxVel = r.maxVel;
...
// _[Find class node: 2916] PHFemMeshState
	public void ApplyTo(PHFemMeshState r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHFemMeshState r, bool apply_to_base_class=true) {
	}
    ...
    public vectorwrapper_Vec3d vertices {
        get { return new vectorwrapper_Vec3d(SprExport.Spr_PHFemMeshDesc_vector_get_vertices(_this)); }
        set { SprExport.Spr_PHFemMeshDesc_vector_set_vertices(_this, value._this); }
    }
        public vectorwrapper_int tets {
            get { return new vectorwrapper_int(SprExport.Spr_PHFemMeshDesc_vector_addr_tets(_this)); }
            set { SprExport.Spr_PHFemMeshDesc_vector_set_tets(_this, value); }
        }
        public vectorwrapper_int faces {
            get { return new vectorwrapper_int(SprExport.Spr_PHFemMeshDesc_vector_addr_faces(_this)); }
            set { SprExport.Spr_PHFemMeshDesc_vector_set_faces(_this, value); }
        }
	public void Init() {
	...
	public vectorwrapper_Vec3d vertices = new vectorwrapper_Vec3d();
	public vectorwrapper_int tets = new vectorwrapper_int();
	public vectorwrapper_int faces = new vectorwrapper_int();
// _[Find class node: 2916] PHFemMeshDesc
	public void ApplyTo(PHFemMeshDesc r, bool apply_to_base_class=true) {
		r.vertices.clear();
		int _PHFemMeshDesc_count_0000 = vertices.size();
		for (int i = 0; i < _PHFemMeshDesc_count_0000; i++) {
			r.vertices.push_back(vertices[i]);
		}
		r.tets.clear();
		int _PHFemMeshDesc_count_0001 = tets.size();
		for (int i = 0; i < _PHFemMeshDesc_count_0001; i++) {
			r.tets.push_back(tets[i]);
		}
		r.faces.clear();
		int _PHFemMeshDesc_count_0002 = faces.size();
		for (int i = 0; i < _PHFemMeshDesc_count_0002; i++) {
			r.faces.push_back(faces[i]);
		}
	}
	public void ApplyFrom(PHFemMeshDesc r, bool apply_to_base_class=true) {
		vertices.clear();
		int _PHFemMeshDesc_count_0000 = r.vertices.size();
		for (int i = 0; i < _PHFemMeshDesc_count_0000; i++) {
			vertices.push_back(r.vertices[i]);
		}
		tets.clear();
		int _PHFemMeshDesc_count_0001 = r.tets.size();
		for (int i = 0; i < _PHFemMeshDesc_count_0001; i++) {
			tets.push_back(r.tets[i]);
		}
		faces.clear();
		int _PHFemMeshDesc_count_0002 = r.faces.size();
		for (int i = 0; i < _PHFemMeshDesc_count_0002; i++) {
	...
	public double radiantHeat;
	public double initial_temp;
// _[Find class node: 2916] PHFemMeshThermoDesc
	public void ApplyTo(PHFemMeshThermoDesc r, bool apply_to_base_class=true) {
		r.rho = rho;
		...
		if (apply_to_base_class) {
		    base.ApplyTo((PHFemMeshDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHFemMeshThermoDesc r, bool apply_to_base_class=true) {
		rho = r.rho;
		...
		if (apply_to_base_class) {
		    base.ApplyFrom((PHFemMeshDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHFemMeshNewState
	public void ApplyTo(PHFemMeshNewState r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHFemMeshNewState r, bool apply_to_base_class=true) {
	}
    ...
    public vectorwrapper_Vec3d vertices {
        get { return new vectorwrapper_Vec3d(SprExport.Spr_PHFemMeshNewDesc_vector_get_vertices(_this)); }
        set { SprExport.Spr_PHFemMeshNewDesc_vector_set_vertices(_this, value._this); }
    }
        public vectorwrapper_int tets {
            get { return new vectorwrapper_int(SprExport.Spr_PHFemMeshNewDesc_vector_addr_tets(_this)); }
            set { SprExport.Spr_PHFemMeshNewDesc_vector_set_tets(_this, value); }
        }
        public vectorwrapper_int faces {
            get { return new vectorwrapper_int(SprExport.Spr_PHFemMeshNewDesc_vector_addr_faces(_this)); }
            set { SprExport.Spr_PHFemMeshNewDesc_vector_set_faces(_this, value); }
        }
	public bool spheric {
	    get {
	...
	public vectorwrapper_int faces = new vectorwrapper_int();
	public bool spheric;
// _[Find class node: 2916] PHFemMeshNewDesc
	public void ApplyTo(PHFemMeshNewDesc r, bool apply_to_base_class=true) {
		r.vertices.clear();
		int _PHFemMeshNewDesc_count_0000 = vertices.size();
		for (int i = 0; i < _PHFemMeshNewDesc_count_0000; i++) {
			r.vertices.push_back(vertices[i]);
		}
		r.tets.clear();
		int _PHFemMeshNewDesc_count_0001 = tets.size();
		for (int i = 0; i < _PHFemMeshNewDesc_count_0001; i++) {
			r.tets.push_back(tets[i]);
		}
		r.faces.clear();
		int _PHFemMeshNewDesc_count_0002 = faces.size();
		for (int i = 0; i < _PHFemMeshNewDesc_count_0002; i++) {
			r.faces.push_back(faces[i]);
		}
		r.spheric = spheric;
	}
	public void ApplyFrom(PHFemMeshNewDesc r, bool apply_to_base_class=true) {
		vertices.clear();
		int _PHFemMeshNewDesc_count_0000 = r.vertices.size();
		for (int i = 0; i < _PHFemMeshNewDesc_count_0000; i++) {
			vertices.push_back(r.vertices[i]);
		}
		tets.clear();
		int _PHFemMeshNewDesc_count_0001 = r.tets.size();
		for (int i = 0; i < _PHFemMeshNewDesc_count_0001; i++) {
			tets.push_back(r.tets[i]);
		}
		faces.clear();
		int _PHFemMeshNewDesc_count_0002 = r.faces.size();
		for (int i = 0; i < _PHFemMeshNewDesc_count_0002; i++) {
			faces.push_back(r.faces[i]);
		}
		spheric = r.spheric;
...
// _[Find class node: 2916] PHFemBaseDesc
	public void ApplyTo(PHFemBaseDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHFemBaseDesc r, bool apply_to_base_class=true) {
	}
	...
	public double beta {
        ...
        public vectorwrapper_int fixedVertices {
            get { return new vectorwrapper_int(SprExport.Spr_PHFemVibrationDesc_vector_addr_fixedVertices(_this)); }
            set { SprExport.Spr_PHFemVibrationDesc_vector_set_fixedVertices(_this, value); }
        }
	...
	public double alpha;
	public double beta;
	public vectorwrapper_int fixedVertices = new vectorwrapper_int();
// _[Find class node: 2916] PHFemVibrationDesc
	public void ApplyTo(PHFemVibrationDesc r, bool apply_to_base_class=true) {
		r.young = young;
		r.poisson = poisson;
		r.density = density;
		r.alpha = alpha;
		r.beta = beta;
		r.fixedVertices.clear();
		int _PHFemVibrationDesc_count_0005 = fixedVertices.size();
		for (int i = 0; i < _PHFemVibrationDesc_count_0005; i++) {
			r.fixedVertices.push_back(fixedVertices[i]);
		}
		if (apply_to_base_class) {
		    base.ApplyTo((PHFemBaseDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHFemVibrationDesc r, bool apply_to_base_class=true) {
		young = r.young;
		poisson = r.poisson;
		density = r.density;
		alpha = r.alpha;
		beta = r.beta;
		fixedVertices.clear();
		int _PHFemVibrationDesc_count_0005 = r.fixedVertices.size();
		for (int i = 0; i < _PHFemVibrationDesc_count_0005; i++) {
			fixedVertices.push_back(r.fixedVertices[i]);
		}
		if (apply_to_base_class) {
		    base.ApplyFrom((PHFemBaseDesc) r, apply_to_base_class);
		}
	}
	...
	public double initial_temp;
	public double weekPow_full;
// _[Find class node: 2916] PHFemThermoDesc
	public void ApplyTo(PHFemThermoDesc r, bool apply_to_base_class=true) {
		r.rho = rho;
		r.heatTrans = heatTrans;
		r.specificHeat = specificHeat;
		r.radiantHeat = radiantHeat;
	...
	public void ApplyFrom(PHFemThermoDesc r, bool apply_to_base_class=true) {
		rho = r.rho;
		heatTrans = r.heatTrans;
		specificHeat = r.specificHeat;
		radiantHeat = r.radiantHeat;
...
// _[Find class node: 2916] PHFemPorousWOMoveDesc
	public void ApplyTo(PHFemPorousWOMoveDesc r, bool apply_to_base_class=true) {
		r.wDiffAir = wDiffAir;
		r.K = K;
		r.kc = kc;
		r.kp = kp;
	...
	public void ApplyFrom(PHFemPorousWOMoveDesc r, bool apply_to_base_class=true) {
		wDiffAir = r.wDiffAir;
		K = r.K;
		kc = r.kc;
		kp = r.kp;
...
// _[Find class node: 2916] PHFrameDesc
	public void ApplyTo(PHFrameDesc r, bool apply_to_base_class=true) {
		r.pose = pose;
	}
	public void ApplyFrom(PHFrameDesc r, bool apply_to_base_class=true) {
		pose = r.pose;
	}
	...
	public PosedStruct pose;
// _[Find class node: 2916] PHSolidState
	public void ApplyTo(PHSolidState r, bool apply_to_base_class=true) {
		r.velocity = velocity;
		r.angVelocity = angVelocity;
		r.pose = pose;
	}
	public void ApplyFrom(PHSolidState r, bool apply_to_base_class=true) {
		velocity = r.velocity;
	...
	public bool dynamical;
	public bool stationary;
// _[Find class node: 2916] PHSolidDesc
	public void ApplyTo(PHSolidDesc r, bool apply_to_base_class=true) {
		r.mass = mass;
		r.inertia = inertia;
		r.center = center;
	...
	public void ApplyFrom(PHSolidDesc r, bool apply_to_base_class=true) {
		mass = r.mass;
		inertia = r.inertia;
		center = r.center;
...
// _[Find class node: 2916] PHHapticPointerDesc
	public void ApplyTo(PHHapticPointerDesc r, bool apply_to_base_class=true) {
		r.renderMode = renderMode;
	}
	public void ApplyFrom(PHHapticPointerDesc r, bool apply_to_base_class=true) {
...
// _[Find class node: 2916] PHHapticEngineDesc
	public void ApplyTo(PHHapticEngineDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHHapticEngineDesc r, bool apply_to_base_class=true) {
	}
...
// _[Find class node: 2916] PHIKEndEffectorState
	public void ApplyTo(PHIKEndEffectorState r, bool apply_to_base_class=true) {
		r.solidTempPose = solidTempPose;
	}
	public void ApplyFrom(PHIKEndEffectorState r, bool apply_to_base_class=true) {
...
// _[Find class node: 2916] PHIKEndEffectorDesc
	public void ApplyTo(PHIKEndEffectorDesc r, bool apply_to_base_class=true) {
		r.bEnabled = bEnabled;
	...
	public void ApplyFrom(PHIKEndEffectorDesc r, bool apply_to_base_class=true) {
		bEnabled = r.bEnabled;
...
// _[Find class node: 2916] PHIKActuatorState
	public void ApplyTo(PHIKActuatorState r, bool apply_to_base_class=true) {
		r.solidTempPose = solidTempPose;
	...
	public void ApplyFrom(PHIKActuatorState r, bool apply_to_base_class=true) {
		solidTempPose = r.solidTempPose;
	...
	public float bias;
	public double pullbackRate;
// _[Find class node: 2916] PHIKActuatorDesc
	public void ApplyTo(PHIKActuatorDesc r, bool apply_to_base_class=true) {
		r.bEnabled = bEnabled;
		r.bias = bias;
		r.pullbackRate = pullbackRate;
	}
	public void ApplyFrom(PHIKActuatorDesc r, bool apply_to_base_class=true) {
		bEnabled = r.bEnabled;
		bias = r.bias;
...
// _[Find class node: 2916] PHIKBallActuatorDesc
	public void ApplyTo(PHIKBallActuatorDesc r, bool apply_to_base_class=true) {
		r.pullbackTarget = pullbackTarget;
		if (apply_to_base_class) {
		    base.ApplyTo((PHIKActuatorDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHIKBallActuatorDesc r, bool apply_to_base_class=true) {
		pullbackTarget = r.pullbackTarget;
		if (apply_to_base_class) {
		    base.ApplyFrom((PHIKActuatorDesc) r, apply_to_base_class);
		}
	}
	...
	public double pullbackTarget;
// _[Find class node: 2916] PHIKHingeActuatorDesc
	public void ApplyTo(PHIKHingeActuatorDesc r, bool apply_to_base_class=true) {
		r.pullbackTarget = pullbackTarget;
		if (apply_to_base_class) {
		    base.ApplyTo((PHIKActuatorDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHIKHingeActuatorDesc r, bool apply_to_base_class=true) {
		pullbackTarget = r.pullbackTarget;
		if (apply_to_base_class) {
		    base.ApplyFrom((PHIKActuatorDesc) r, apply_to_base_class);
		}
...
// _[Find class node: 2916] PHIKSpringActuatorDesc
	public void ApplyTo(PHIKSpringActuatorDesc r, bool apply_to_base_class=true) {
		r.pullbackTarget = pullbackTarget;
		if (apply_to_base_class) {
		    base.ApplyTo((PHIKActuatorDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHIKSpringActuatorDesc r, bool apply_to_base_class=true) {
		pullbackTarget = r.pullbackTarget;
		if (apply_to_base_class) {
		    base.ApplyFrom((PHIKActuatorDesc) r, apply_to_base_class);
		}
...
// _[Find class node: 2916] PHConstraintDesc
	public void ApplyTo(PHConstraintDesc r, bool apply_to_base_class=true) {
		r.bEnabled = bEnabled;
		r.poseSocket = poseSocket;
		r.posePlug = posePlug;
	}
	public void ApplyFrom(PHConstraintDesc r, bool apply_to_base_class=true) {
		bEnabled = r.bEnabled;
	...
	public double fMax;
// _[Find class node: 2916] PHJointDesc
	public void ApplyTo(PHJointDesc r, bool apply_to_base_class=true) {
		r.fMax = fMax;
		if (apply_to_base_class) {
		    base.ApplyTo((PHConstraintDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHJointDesc r, bool apply_to_base_class=true) {
		fMax = r.fMax;
		if (apply_to_base_class) {
		    base.ApplyFrom((PHConstraintDesc) r, apply_to_base_class);
		}
	}
	...
	public double hardnessRate;
	public double secondMoment;
// _[Find class node: 2916] PH1DJointDesc
	public void ApplyTo(PH1DJointDesc r, bool apply_to_base_class=true) {
		r.cyclic = cyclic;
		r.spring = spring;
		r.damper = damper;
		...
		if (apply_to_base_class) {
		    base.ApplyTo((PHJointDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PH1DJointDesc r, bool apply_to_base_class=true) {
		cyclic = r.cyclic;
		spring = r.spring;
		damper = r.damper;
		...
		if (apply_to_base_class) {
		    base.ApplyFrom((PHJointDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHHingeJointDesc
	public void ApplyTo(PHHingeJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PH1DJointDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHHingeJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PH1DJointDesc) r, apply_to_base_class);
		}
	}
	...
	public bool bConstraintRollX;
	public bool bConstraintRollZ;
// _[Find class node: 2916] PHSliderJointDesc
	public void ApplyTo(PHSliderJointDesc r, bool apply_to_base_class=true) {
	...
	public void ApplyFrom(PHSliderJointDesc r, bool apply_to_base_class=true) {
    ...
    public vectorwrapper_PHPathPoint points {
        get { return new vectorwrapper_PHPathPoint(SprExport.Spr_PHPathDesc_vector_get_points(_this)); }
        set { SprExport.Spr_PHPathDesc_vector_set_points(_this, value._this); }
    }
	public bool bLoop {
	    get {
	...
	public vectorwrapper_PHPathPoint points = new vectorwrapper_PHPathPoint();
	public bool bLoop;
// _[Find class node: 2916] PHPathDesc
	public void ApplyTo(PHPathDesc r, bool apply_to_base_class=true) {
		r.points.clear();
		int _PHPathDesc_count_0000 = points.size();
		for (int i = 0; i < _PHPathDesc_count_0000; i++) {
			r.points.push_back(points[i]);
		}
		r.bLoop = bLoop;
	}
	public void ApplyFrom(PHPathDesc r, bool apply_to_base_class=true) {
		points.clear();
		int _PHPathDesc_count_0000 = r.points.size();
		for (int i = 0; i < _PHPathDesc_count_0000; i++) {
...
// _[Find class node: 2916] PHPathJointDesc
	public void ApplyTo(PHPathJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PH1DJointDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHPathJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PH1DJointDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHGenericJointDesc
	public void ApplyTo(PHGenericJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PH1DJointDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHGenericJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PH1DJointDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHBallJointDesc
	public void ApplyTo(PHBallJointDesc r, bool apply_to_base_class=true) {
		r.spring = spring;
		r.damper = damper;
		r.secondDamper = secondDamper;
		r.targetPosition = targetPosition;
	...
	public void ApplyFrom(PHBallJointDesc r, bool apply_to_base_class=true) {
		spring = r.spring;
		damper = r.damper;
		secondDamper = r.secondDamper;
		targetPosition = r.targetPosition;
...
// _[Find class node: 2916] PHFixJointDesc
	public void ApplyTo(PHFixJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHJointDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHFixJointDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHJointDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHSpringDesc
	public void ApplyTo(PHSpringDesc r, bool apply_to_base_class=true) {
		r.targetPosition = targetPosition;
		r.targetOrientation = targetOrientation;
		r.spring = spring;
		r.damper = damper;
	...
	public void ApplyFrom(PHSpringDesc r, bool apply_to_base_class=true) {
		targetPosition = r.targetPosition;
		targetOrientation = r.targetOrientation;
		spring = r.spring;
		damper = r.damper;
...
// _[Find class node: 2916] PHMateDesc
	public void ApplyTo(PHMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHJointDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHJointDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHPointToPointMateDesc
	public void ApplyTo(PHPointToPointMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHMateDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHPointToPointMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHMateDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHPointToLineMateDesc
	public void ApplyTo(PHPointToLineMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHMateDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHPointToLineMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHMateDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHPointToPlaneMateDesc
	public void ApplyTo(PHPointToPlaneMateDesc r, bool apply_to_base_class=true) {
		r.range = range;
		if (apply_to_base_class) {
		    base.ApplyTo((PHMateDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHPointToPlaneMateDesc r, bool apply_to_base_class=true) {
		range = r.range;
		if (apply_to_base_class) {
		    base.ApplyFrom((PHMateDesc) r, apply_to_base_class);
		}
...
// _[Find class node: 2916] PHLineToLineMateDesc
	public void ApplyTo(PHLineToLineMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHMateDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHLineToLineMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHMateDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHPlaneToPlaneMateDesc
	public void ApplyTo(PHPlaneToPlaneMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHMateDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHPlaneToPlaneMateDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHMateDesc) r, apply_to_base_class);
		}
	}
	...
	public bool bEnabled;
// _[Find class node: 2916] PHTreeNodeDesc
	public void ApplyTo(PHTreeNodeDesc r, bool apply_to_base_class=true) {
		r.bEnabled = bEnabled;
	}
	public void ApplyFrom(PHTreeNodeDesc r, bool apply_to_base_class=true) {
		bEnabled = r.bEnabled;
	}
...
// _[Find class node: 2916] PHRootNodeDesc
	public void ApplyTo(PHRootNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHRootNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHTreeNode1DDesc
	public void ApplyTo(PHTreeNode1DDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHTreeNode1DDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHHingeJointNodeDesc
	public void ApplyTo(PHHingeJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHHingeJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHSliderJointNodeDesc
	public void ApplyTo(PHSliderJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHSliderJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHPathJointNodeDesc
	public void ApplyTo(PHPathJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHPathJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHGenericJointNodeDesc
	public void ApplyTo(PHGenericJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHGenericJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNode1DDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHBallJointNodeDesc
	public void ApplyTo(PHBallJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHBallJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHFixJointNodeDesc
	public void ApplyTo(PHFixJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHFixJointNodeDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHTreeNodeDesc) r, apply_to_base_class);
		}
	}
	...
	public double offset;
	public int mode;
// _[Find class node: 2916] PHGearDesc
	public void ApplyTo(PHGearDesc r, bool apply_to_base_class=true) {
		r.bEnabled = bEnabled;
		r.ratio = ratio;
		r.offset = offset;
		r.mode = mode;
	}
	public void ApplyFrom(PHGearDesc r, bool apply_to_base_class=true) {
		bEnabled = r.bEnabled;
		ratio = r.ratio;
		offset = r.offset;
		mode = r.mode;
	...
	public double damper;
	public Vec2dStruct range;
// _[Find class node: 2916] PH1DJointLimitDesc
	public void ApplyTo(PH1DJointLimitDesc r, bool apply_to_base_class=true) {
		r.bEnabled = bEnabled;
		r.spring = spring;
		r.damper = damper;
		r.range = range;
	}
	public void ApplyFrom(PH1DJointLimitDesc r, bool apply_to_base_class=true) {
		bEnabled = r.bEnabled;
		spring = r.spring;
		damper = r.damper;
		range = r.range;
...
// _[Find class node: 2916] PHBallJointLimitDesc
	public void ApplyTo(PHBallJointLimitDesc r, bool apply_to_base_class=true) {
		r.bEnabled = bEnabled;
		r.spring = spring;
		r.damper = damper;
		r.limitDir = limitDir;
	}
	public void ApplyFrom(PHBallJointLimitDesc r, bool apply_to_base_class=true) {
		bEnabled = r.bEnabled;
		spring = r.spring;
		damper = r.damper;
		limitDir = r.limitDir;
...
// _[Find class node: 2916] PHBallJointConeLimitDesc
	public void ApplyTo(PHBallJointConeLimitDesc r, bool apply_to_base_class=true) {
		r.limitSwing = limitSwing;
		r.limitSwingDir = limitSwingDir;
		r.limitTwist = limitTwist;
		if (apply_to_base_class) {
		    base.ApplyTo((PHBallJointLimitDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHBallJointConeLimitDesc r, bool apply_to_base_class=true) {
		limitSwing = r.limitSwing;
		limitSwingDir = r.limitSwingDir;
		limitTwist = r.limitTwist;
		if (apply_to_base_class) {
		    base.ApplyFrom((PHBallJointLimitDesc) r, apply_to_base_class);
		}
	}
    ...
    public vectorwrapper_PHSplineLimitNode nodes {
        get { return new vectorwrapper_PHSplineLimitNode(SprExport.Spr_PHBallJointSplineLimitDesc_vector_get_nodes(_this)); }
        set { SprExport.Spr_PHBallJointSplineLimitDesc_vector_set_nodes(_this, value._this); }
    }
	...
	public vectorwrapper_PHSplineLimitNode nodes = new vectorwrapper_PHSplineLimitNode();
	public Vec2dStruct poleTwist;
// _[Find class node: 2916] PHBallJointSplineLimitDesc
	public void ApplyTo(PHBallJointSplineLimitDesc r, bool apply_to_base_class=true) {
		r.nodes.clear();
		int _PHBallJointSplineLimitDesc_count_0000 = nodes.size();
		for (int i = 0; i < _PHBallJointSplineLimitDesc_count_0000; i++) {
			r.nodes.push_back(nodes[i]);
		}
	...
	public void ApplyFrom(PHBallJointSplineLimitDesc r, bool apply_to_base_class=true) {
		nodes.clear();
		int _PHBallJointSplineLimitDesc_count_0000 = r.nodes.size();
		for (int i = 0; i < _PHBallJointSplineLimitDesc_count_0000; i++) {
			nodes.push_back(r.nodes[i]);
		}
...
// _[Find class node: 2916] PHBallJointIndependentLimitDesc
	public void ApplyTo(PHBallJointIndependentLimitDesc r, bool apply_to_base_class=true) {
		r.limitX = limitX;
		r.limitY = limitY;
		r.limitZ = limitZ;
		if (apply_to_base_class) {
	...
	public void ApplyFrom(PHBallJointIndependentLimitDesc r, bool apply_to_base_class=true) {
		limitX = r.limitX;
		limitY = r.limitY;
		limitZ = r.limitZ;
		if (apply_to_base_class) {
...
// _[Find class node: 2916] PH1DJointMotorDesc
	public void ApplyTo(PH1DJointMotorDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PH1DJointMotorDesc r, bool apply_to_base_class=true) {
	}
...
// _[Find class node: 2916] PH1DJointNonLinearMotorDesc
	public void ApplyTo(PH1DJointNonLinearMotorDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PH1DJointMotorDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PH1DJointNonLinearMotorDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PH1DJointMotorDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHHuman1DJointResistanceDesc
	public void ApplyTo(PHHuman1DJointResistanceDesc r, bool apply_to_base_class=true) {
		r.coefficient = coefficient;
		if (apply_to_base_class) {
		    base.ApplyTo((PH1DJointNonLinearMotorDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHHuman1DJointResistanceDesc r, bool apply_to_base_class=true) {
		coefficient = r.coefficient;
		if (apply_to_base_class) {
		    base.ApplyFrom((PH1DJointNonLinearMotorDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHBallJointMotorDesc
	public void ApplyTo(PHBallJointMotorDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHBallJointMotorDesc r, bool apply_to_base_class=true) {
	}
...
// _[Find class node: 2916] PHBallJointNonLinearMotorDesc
	public void ApplyTo(PHBallJointNonLinearMotorDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyTo((PHBallJointMotorDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHBallJointNonLinearMotorDesc r, bool apply_to_base_class=true) {
		if (apply_to_base_class) {
		    base.ApplyFrom((PHBallJointMotorDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHHumanBallJointResistanceDesc
	public void ApplyTo(PHHumanBallJointResistanceDesc r, bool apply_to_base_class=true) {
		r.xCoefficient = xCoefficient;
		r.yCoefficient = yCoefficient;
		r.zCoefficient = zCoefficient;
		if (apply_to_base_class) {
		    base.ApplyTo((PHBallJointNonLinearMotorDesc) r, apply_to_base_class);
		}
	}
	public void ApplyFrom(PHHumanBallJointResistanceDesc r, bool apply_to_base_class=true) {
		xCoefficient = r.xCoefficient;
		yCoefficient = r.yCoefficient;
		zCoefficient = r.zCoefficient;
		if (apply_to_base_class) {
		    base.ApplyFrom((PHBallJointNonLinearMotorDesc) r, apply_to_base_class);
		}
	}
...
// _[Find class node: 2916] PHSpringMotorDesc
	public void ApplyTo(PHSpringMotorDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHSpringMotorDesc r, bool apply_to_base_class=true) {
	}
	...
	public Vec3dStruct angVelocity;
	public PosedStruct pose;
// _[Find class node: 2916] PHOpObjState
	public void ApplyTo(PHOpObjState r, bool apply_to_base_class=true) {
		r.velocity = velocity;
		r.angVelocity = angVelocity;
		r.pose = pose;
	}
	public void ApplyFrom(PHOpObjState r, bool apply_to_base_class=true) {
		velocity = r.velocity;
		angVelocity = r.angVelocity;
		pose = r.pose;
	}
...
// _[Find class node: 2916] PHOpHapticRendererDesc
	public void ApplyTo(PHOpHapticRendererDesc r, bool apply_to_base_class=true) {
	...
	public void ApplyFrom(PHOpHapticRendererDesc r, bool apply_to_base_class=true) {
	...
	public Vec3f objTargetVts {
        ...
        public arraywrapper_float objTargetVtsArr {
            get { arraywrapper_float wapper = new arraywrapper_float(SprExport.Spr_PHOpObjDesc_array_addr_objTargetVtsArr(_this), 10000);
                  return wapper;
            }
            set { SprExport.Spr_PHOpObjDesc_array_set_objTargetVtsArr(_this, value); }
        }
	...
	public arraywrapper_float objTargetVtsArr = new arraywrapper_float(10000);
	public int objTargetVtsNum;
	public int assPsNum;
	public int assGrpNum;
	public int objGrouplinkCount;
	...
	public int objitrTime;
	public bool updateNormals;
// _[Find class node: 2916] PHOpObjDesc
	public void ApplyTo(PHOpObjDesc r, bool apply_to_base_class=true) {
		r.mass = mass;
		r.inertia = inertia;
		r.center = center;
		r.dynamical = dynamical;
	...
	public void ApplyFrom(PHOpObjDesc r, bool apply_to_base_class=true) {
		mass = r.mass;
		inertia = r.inertia;
		center = r.center;
		dynamical = r.dynamical;
	...
	public Vec3f pExternalDisplacement {
        ...
        public vectorwrapper_int pFaceInd {
            get { return new vectorwrapper_int(SprExport.Spr_PHOpParticleDesc_vector_addr_pFaceInd(_this)); }
            set { SprExport.Spr_PHOpParticleDesc_vector_set_pFaceInd(_this, value); }
        }
	...
	public vectorwrapper_int pFaceInd = new vectorwrapper_int();
...
// _[Find class node: 2916] PHOpParticleDesc
	public void ApplyTo(PHOpParticleDesc r, bool apply_to_base_class=true) {
		r.pNvertex = pNvertex;
		...
		r.pFaceInd.clear();
		int _PHOpParticleDesc_count_0029 = pFaceInd.size();
		for (int i = 0; i < _PHOpParticleDesc_count_0029; i++) {
			r.pFaceInd.push_back(pFaceInd[i]);
		}
		r.pMomentR = pMomentR;
		r.pSmR = pSmR;
	...
	public void ApplyFrom(PHOpParticleDesc r, bool apply_to_base_class=true) {
		pNvertex = r.pNvertex;
		...
		pFaceInd.clear();
		int _PHOpParticleDesc_count_0029 = r.pFaceInd.size();
		for (int i = 0; i < _PHOpParticleDesc_count_0029; i++) {
			pFaceInd.push_back(r.pFaceInd[i]);
		}
		pMomentR = r.pMomentR;
		pSmR = r.pSmR;
	...
	public int gNptcl;
// _[Find class node: 2916] PHOpGroupDesc
	public void ApplyTo(PHOpGroupDesc r, bool apply_to_base_class=true) {
		r.gMyIndex = gMyIndex;
		r.gAgroup = gAgroup;
		r.gEigen = gEigen;
	...
	public void ApplyFrom(PHOpGroupDesc r, bool apply_to_base_class=true) {
		gMyIndex = r.gMyIndex;
		gAgroup = r.gAgroup;
		gEigen = r.gEigen;
	...
	public float proxyRadius;
	public int surrCnstrs;
// _[Find class node: 2916] PHOpHapticControllerDesc
	public void ApplyTo(PHOpHapticControllerDesc r, bool apply_to_base_class=true) {
		r.posScale = posScale;
		r.rotScale = rotScale;
	...
	public void ApplyFrom(PHOpHapticControllerDesc r, bool apply_to_base_class=true) {
		posScale = r.posScale;
		rotScale = r.rotScale;
	...
	public float timestep;
// _[Find class node: 2916] PHOpAnimationDesc
	public void ApplyTo(PHOpAnimationDesc r, bool apply_to_base_class=true) {
		r.timestep = timestep;
	}
	public void ApplyFrom(PHOpAnimationDesc r, bool apply_to_base_class=true) {
		timestep = r.timestep;
	}
	...
	public bool useDirColli;
	public float collisionCstrStiffness;
// _[Find class node: 2916] PHOpSpHashColliAgentDesc
	public void ApplyTo(PHOpSpHashColliAgentDesc r, bool apply_to_base_class=true) {
		r.useDirColli = useDirColli;
		r.collisionCstrStiffness = collisionCstrStiffness;
	}
	public void ApplyFrom(PHOpSpHashColliAgentDesc r, bool apply_to_base_class=true) {
...
// _[Find class node: 2916] PHRayDesc
	public void ApplyTo(PHRayDesc r, bool apply_to_base_class=true) {
		r.origin = origin;
		r.direction = direction;
	}
	public void ApplyFrom(PHRayDesc r, bool apply_to_base_class=true) {
		origin = r.origin;
	...
	public double haptictimeStep;
	public uint count;
// _[Find class node: 2916] PHSceneState
	public void ApplyTo(PHSceneState r, bool apply_to_base_class=true) {
		r.timeStep = timeStep;
		r.haptictimeStep = haptictimeStep;
		r.count = count;
	}
	public void ApplyFrom(PHSceneState r, bool apply_to_base_class=true) {
		timeStep = r.timeStep;
	...
	public int broadPhaseMode;
	public int blendMode;
// _[Find class node: 2916] PHSceneDesc
	public void ApplyTo(PHSceneDesc r, bool apply_to_base_class=true) {
		r.gravity = gravity;
	...
	public void ApplyFrom(PHSceneDesc r, bool apply_to_base_class=true) {
		gravity = r.gravity;
...
// _[Find class node: 2916] PHSdkDesc
	public void ApplyTo(PHSdkDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHSdkDesc r, bool apply_to_base_class=true) {
	}
...
// _[Find class node: 2916] PHBoneDesc
	public void ApplyTo(PHBoneDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHBoneDesc r, bool apply_to_base_class=true) {
	}
...
// _[Find class node: 2916] PHSkeletonDesc
	public void ApplyTo(PHSkeletonDesc r, bool apply_to_base_class=true) {
	}
	public void ApplyFrom(PHSkeletonDesc r, bool apply_to_base_class=true) {
	}
	...
	public arraywrapper_PHOpObjDesc GetOpObj(int i) {
	    IntPtr ptr = SprExport.Spr_PHOpEngineIf_GetOpObj((IntPtr) _this, (int) i);
            ...
            return new arraywrapper_PHOpObjDesc(ptr, size);
	}
	...
	public bool SetConcentricHeatMap(vectorwrapper_double r, vectorwrapper_double temp, Vec2d origin) {
	    char ret = SprExport.Spr_PHFemMeshThermoIf_SetConcentricHeatMap((IntPtr) _this, (IntPtr) r._this, (IntPtr) temp._this, (IntPtr) origin);
	    return (ret == 0) ? false : true;
	}
	...
	public int[] GetTetVertexIds(int t) {
	    IntPtr ptr = SprExport.Spr_PHFemMeshNewIf_GetTetVertexIds((IntPtr) _this, (int) t);
            int size = 1;   // no way to know array size!
            return new arraywrapper_int(ptr, size);
	}
	public int[] GetFaceVertexIds(int f) {
	    IntPtr ptr = SprExport.Spr_PHFemMeshNewIf_GetFaceVertexIds((IntPtr) _this, (int) f);
            int size = 1;   // no way to know array size!
            return new arraywrapper_int(ptr, size);
	}
	...
	public bool SetConcentricHeatMap(vectorwrapper_double r, vectorwrapper_double temp, Vec2d origin) {
	    char ret = SprExport.Spr_PHFemThermoIf_SetConcentricHeatMap((IntPtr) _this, (IntPtr) r._this, (IntPtr) temp._this, (IntPtr) origin);
	    return (ret == 0) ? false : true;
	}
	public void SetThermalEmissivityToVerticesAll(double thermalEmissivity, double thermalEmissivity_const) {
	...
	public bool InvalidateBbox() {
	    char ret = SprExport.Spr_PHBodyIf_InvalidateBbox((IntPtr) _this);
	    return (ret == 0) ? false : true;
	}
    }
	...
	public Posed GetPose() {
	    IntPtr ptr = SprExport.Spr_PHContactPointIf_GetPose((IntPtr) _this);
            return new Posed(ptr, true);
	}
	public bool IsStaticFriction() {
	    char ret = SprExport.Spr_PHContactPointIf_IsStaticFriction((IntPtr) _this);
	    return (ret == 0) ? false : true;
	}
    }
	...
	public arraywrapper_PHOpParticleDesc GetParticleDesc() {
	    IntPtr ptr = SprExport.Spr_PHOpParticleIf_GetParticleDesc((IntPtr) _this);
            int size = 1;   // no way to know array size!
            return new arraywrapper_PHOpParticleDesc(ptr, size);
	}
    }
	...
	public arraywrapper_PHOpGroupDesc GetGroupDesc() {
	    IntPtr ptr = SprExport.Spr_PHOpGroupIf_GetGroupDesc((IntPtr) _this);
            int size = 1;   // no way to know array size!
            return new arraywrapper_PHOpGroupDesc(ptr, size);
	}
    }
	...
	public arraywrapper_PHRaycastHit GetHits() {
	    IntPtr ptr = SprExport.Spr_PHRayIf_GetHits((IntPtr) _this);
            int size = 1;   // no way to know array size!
            return new arraywrapper_PHRaycastHit(ptr, size);
	}
	...
	public void GetMaterialBlending() {
	    SprExport.Spr_PHSceneIf_GetMaterialBlending((IntPtr) _this);
	}
	public void Step() {
